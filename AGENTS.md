...
| feature-spec-creation | Creating or updating feature specs/proposals | .opencode/skills/feature-spec-creation/SKILL.md |
| configuration-management | Accessing env vars or adding new settings | .opencode/skills/configuration-management/SKILL.md |
| architecture-awareness | Making architectural decisions, Understanding architectural constraints, or checking existing patterns | .opencode/skills/architecture-awareness/SKILL.md |
